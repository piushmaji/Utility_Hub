...
import { Menu, X, Command, Languages, Shuffle, Info, Home } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex-shrink-0 flex items-center">
            <Link to="/" onClick={closeMenu} className="flex items-center gap-2 group">
              <div className="p-1.5 rounded-lg bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-950 group-hover:bg-blue-600 dark:group-hover:bg-blue-500 group-hover:text-white dark:group-hover:text-white transition-all duration-200">
